...
-- question 7: 
select departments.dept_name, count(employees.dept_id) from departments left join employees on departments.dept_id = employees.dept_id group by departments.dept_name;
